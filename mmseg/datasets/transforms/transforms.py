...
class NPPTest(BaseTransform):
    ...
    def __init__(self):
        ...
        NPP_path = os.path.join(abs_path, 'NoisePrintPlus/npp.pth')
        self.NPP_path = os.path.join(os.getcwd(), NPP_path)
        ...
        self.npp_net = torch.load(self.NPP_path, map_location=torch.device('cpu'))
        for _, v in self.npp_net.named_parameters():
           v.requires_grad=False

        
        self.npp_net.to('cuda:0')
